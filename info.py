...
API_ID = int(environ.get('API_ID', '39047562'))
API_HASH = environ.get('API_HASH', '1804377b8fc71ff1d2f7dd70c4b16dca')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://houaidjihoussem_db_user:41eOz8Cuy2OiGBy3@cluster0.nj3eywa.mongodb.net/?appName=Cluster0")
...
# Others
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003473060940'))
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002647046942')).split()]
